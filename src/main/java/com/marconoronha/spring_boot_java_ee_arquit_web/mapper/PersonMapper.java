...
@Component
@Log
@Priority(PriorityOrdered.HIGHEST_PRECEDENCE) //Resolve ambiguidade de Beans no @Controller definindo a ordem de prioridade da classe
public class PersonMapper implements DTOToObjectMapper<PersonDTO, Person> {
    ...
    public PersonMapper(ModelMapper modelMapper){
        ...
        log.warning("Person mapper, with highest-precedence order, loaded at application context");
    }
