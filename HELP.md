...
* The original package name 'com.marconoronha.spring-boot-java-ee-arquit-web' is invalid and this project uses 'com.marconoronha.spring_boot_java_ee_arquit_web' instead.
